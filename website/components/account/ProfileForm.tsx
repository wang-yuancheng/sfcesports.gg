    ...
    <div className="bg-gray-50 rounded-2xl p-1 pb-8 w-full shadow-sm border border-gray-100/50">
      ...
      <div className="px-8 relative mb-8">
        <div className="flex justify-between items-end -mt-12">
            ...
            {/* View Profile Button */}
            <Button variant="default" className="bg-black text-white hover:bg-gray-800 rounded-lg mb-2">
                View Profile
            </Button>
        </div>
      </div>
      ...
      {/* Form Fields */}
      <form onSubmit={updateProfile} className="px-8 flex flex-col gap-6 max-w-2xl">
